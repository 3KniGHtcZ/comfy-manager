...
export function PromptInput({
  ...
  return (
    <div className={cn("flex flex-col gap-2.5 w-full", className)}>
      {label && (
        <label className="text-[14px] font-semibold text-[#1A1918] font-[Outfit]">
          {label}
        </label>
      )}
      <div className="w-full rounded-xl bg-white border border-[#D1D0CD] p-3.5" style={{ borderWidth: "1.5px" }}>
        <textarea
          value={value}
