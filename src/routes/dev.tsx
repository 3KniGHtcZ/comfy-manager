    ...
    <div className="min-h-screen bg-[#FAF9F7] pb-24">
      ...
      <div className="px-6 flex flex-col gap-10 mt-4">
        ...
        <section className="flex flex-col gap-3">
          <h2 className="text-[11px] font-semibold text-[#9C9B99] uppercase tracking-wider font-[Outfit]">
            Buttons
          </h2>
        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <CharacterCard
              name="Anime Girl"
              description="Colorful anime style with vibrant backgrounds"
            />
            <CharacterCard
              name="Realistic"
        ...
        <section className="flex flex-col gap-3">
          ...
          />
          <RecentImageCard name="Portrait study" info="15 min ago · 768×768" />
        </section>
